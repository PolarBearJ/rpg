...
//
    ...
    @Override
    public void tick() {
//        System.out.println(currentNanoTime/60);
//        System.out.println(lastFireNanoTime/60 + "last");
        currentNanoTime++;
        this.x = warrior.getX();
        this.y = warrior.getY();
        if((currentNanoTime) - (lastFireNanoTime) >= 60/getShotsPerSecond()){
//            System.out.println((currentNanoTime) - (lastFireNanoTime));
            fire();
            lastFireNanoTime = currentNanoTime;
        }
        // if currentNanoTime - lastFireNanoTime > shotsPerSecond * 1000000000
        //   fire bullet
        //   lastFireNanoTime = currentNanoTime
    }
